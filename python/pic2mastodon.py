...
# This script won't upload any pictures included in "0archive_mastodon.txt"
# The script looks up all pictures in the given directory
# and compares their filenames with "0archive_mastodon.txt"
# The script will post the first "new" pictures it founds to Mastodon and exits. So, 
...
access_token 	= "YY XX ZZ " 			# get the api-token via your account website
#---------------------------------------------
#########################################################
